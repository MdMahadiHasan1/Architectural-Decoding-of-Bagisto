...
|-------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------|
| **Implementation Decision**   | Modular Laravel-based architecture allows plug-and-play capabilities for modules like inventory, checkout, and customer management.                                                                                                                  | 112          | 20.15%     |
| **Technology Decision**       | Laravel for back-end and Vue.js for front-end for leveraging ecosystem maturity.                                                                                                                                                                       | 89           | 16.00%     |
| **Architecture Pattern Decision** | Uses MVC for modular separation; additionally includes CQRS for command-query separation in APIs and Event-Driven Architecture in order placement and notification flows.                                                              | 75           | 13.49%     |
| **Component Decision**        | Admin panel architected as a reusable component to support both B2B and B2C independently from the storefront.                                                                                                                                        | 60           | 10.79%     |
| **Tool Decision**             | Composer for PHP dependency management; Webpack and Vite for front-end bundling.                                                                                                                                                                       | 58           | 10.43%     |
| **Data Decision**             | Eloquent ORM with relational DB support for catalogs, users, and transactional data.                                                                                                                                                                   | 47           | 8.45%      |
| **Decomposition Decision**    | Modules for Catalog, Checkout, Customer, Admin, and API for better scalability and contribution.                                                                                                                                                      | 30           | 5.39%      |
| **Integration Decision**      | REST and GraphQL APIs integrate with ERP, CRM, and payment systems.                                                                                                                                                                                    | 21           | 3.78%      |
| **Behavior Decision**         | Cart supports guest checkout and session persistence without login.                                                                                                                                                                                    | 18           | 3.24%      |
| **Design Pattern Decision**   | Repository and Service Provider patterns used for business logic separation.                                                                                                                                                                           | 12           | 2.16%      |
| **Service Decision**          | Separate services for queueing: email, order placement, and indexing.                                                                                                                                                                                  | 9            | 1.62%      |
| **Testing Decision**          | PHPUnit (back-end) and Jest (front-end) for unit/integration testing.                                                                                                                                                                                  | 8            | 1.44%      |
| **Deployment Decision**       | Docker scripts for cross-platform deployment and cloud compatibility.                                                                                                                                                                                  | 7            | 1.26%      |
| **Containerization Decision** | Docker Compose with isolated containers for DB, PHP runtime, NGINX, and cache.                                                                                                                                                                         | 6            | 1.08%      |
| **Concurrency Decision**      | Laravel queues + Redis broadcasting for async tasks like notifications.                                                                                                                                                                                | 4            | 0.72%      |
| **Other Patterns**            | Includes Dependency Injection (via Laravel Service Container), Singleton (for services like config), and Observer (for model event handling).                                                                                                        | —            | —          |
